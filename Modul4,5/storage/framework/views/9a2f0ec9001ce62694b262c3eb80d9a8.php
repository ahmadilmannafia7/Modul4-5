...
<button type="button" class="navbar-toggler" data-bstoggle="collapse" data-bs-target="#navbarSupportedContent">
    ...
    id="firstName" name="firstName" value="<?php echo e($employee->firstname); ?>">
    </div>
    <div class="col-md-12 mb-3">
    <label for="lastName" class="form-label">Last
    Name</label>
    <input type="text" class="form-control"
    id="lastName" name="lastName" value="<?php echo e($employee->lastname); ?>">
    </div>
    <div class="col-md-12 mb-3">
    <label for="email" class="formlabel">Email</label>
    <input type="email" class="form-control"
    id="email" name="email" value="<?php echo e($employee->email); ?>">
    </div>
    <div class="col-md-12 mb-3">
    <label for="age" class="form-label">Age</label>
    <input type="number" class="form-control" id="age"
    name="age" value="<?php echo e($employee->age); ?>">
    </div>
    <div class="col-md-12 mb-3">
    ...
    class="btn btn-outline-dark btn-lg mt-3"><i class="bi-arrow-left-circle me2"></i> Back</a>
    </div>
    <div class="col-md-6 text-right">
    <button type="submit" class="btn btn-outlinesecondary btn-lg mt-3"><i class="bi-pencil-square me-2"></i> Update</button>
    </div>
    </div>
    </form>
    </div>
...
<?php /**PATH C:\xampp\htdocs\modul4\resources\views/employee/edit.blade.php ENDPATH**/ ?>